import mobileGreenflow from "/assets/images/Mobile-Greenflow.png"
...
export default function Download () {
    return (
        ...
        <div className="flex flex-row bg-green-700 justify-between gap-5 p-6 rounded-xl mobile:flex-col mobile:items-center">
            <img src={mobileGreenflow} alt="mobile app" className="h-56 mobile:h-56 mobile:w-28 transform -rotate-12" />
