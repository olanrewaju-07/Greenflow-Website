...
export default function Footer () {
    return (
        <div className="flex flex-col gap-3 bg-green-700">
            <div className="flex flex-row justify-between mb-5 mobile:flex-col tablet:justify-center">
                ...
                <span className="text-white text-[15px] w-[50%] mobile:w-full tablet:w-[80%] px-6 tablet:p-0 font-semibold opacity-80 mobile:text-center">Our mission is to deliver the freshest produce directly from local farmers to consumers, supported by refrigerated transport and real-time tracking to ensure quality and transparency.</span>
                </div>
                <div className="flex flex-row gap-10 mt-10 mobile:grid mobile:grid-cols-2 mobile:ml-5 w-full tablet:grid tablet:grid-cols-2">
                    ...
                    <div className="flex flex-col items-start gap-4">
                        ...
                        <span className="text-white font-semibold text-[15px] opacity-80 w-[50%] mobile:w-full">
