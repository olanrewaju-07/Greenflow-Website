export default function HeroSection() {
  return (
    <div className="pt-20 mb-10 relative bg-[#167206] mobile:pt-8 tablet:mb-0">
      {/* Background Image */}
      ...
      <div className="flex flex-row mobile:flex-col items-center lg:items-start px-8 lg:px-16 relative z-10 mobile:gap-4">
        {/* Left Text Section */}
        <div className="lg:w-1/2 mobile:order-2 tablet:w-1/2 mobile:w-full">
          ...
          <div className="flex gap-4 mt-20 relative z-20 items-center mobile:justify-center">
        ...
        {/* Right Image Section */}
        <div className="relative lg:w-1/2 flex justify-center mobile:order-1 tablet:w-1/2">
          <img
            src="/assets/images/Group 76.svg"
            alt="Hands holding soil"
            className="rounded-full w-80 h-80 object-cover z-10 mobile:w-40 mobile:h-40 tablet:w-60 tablet:h-60"
          />
        </div>
      </div>
    </div>
