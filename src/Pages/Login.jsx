...
export default function Login () {
    ...
    return (
        <div className="relative flex flex-col lg:flex-row justify-between h-screen   tablet:bg-green-950 tablet:h-screen">
        ...
        <div className="flex flex-row bg-gray-200 rounded-md p-1 items-center lg:w-fit gap-3">
            ...
            className={`${activeForm === "farmer" ? "bg-green-800 text-white": "bg-white text-green-950"} rounded-md p-1 text-[15px] font-semibold`}>Login as Farmer</button>
        ...
        <div className="w-full">
            ...
            {activeForm === "buyer"  && <BuyerLogin/>}
             ...
             <img src="/assets/images/GreenLeaf.svg" alt="signup image" className="w-1/2 h-fit object-cover rounded-l-2xl tablet:hidden" />
        </div>
    )
}